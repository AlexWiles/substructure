...
| `tool_discovery` | string | The default for each connection: `all` (the default) or `search`. A connection overrides it in `tools.discovery`. See [Deferred tools](./65-deferred-tools.md). |

...
(`sub_agent.requested` includes the child's `session_id` — open a second
...
type ClientInput =
    ...
    | { type: "client.append"; agent_id: string; turn_id?: string; messages: Message[]; stream?: boolean; client?: ClientContext }

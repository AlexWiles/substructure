...
- [Core concepts](./02-concepts.md): the mental model: agents, workers, sessions, turns, events.
- [CLI](./03-cli.md): install and use the `substructure` command.
- [SDK](./04-sdk.md): build agents in your TypeScript codebase.

...
export const GROUPING_RULES: GroupingRule[] = [
  {
    ...
    correlationId: (p) => {
      switch (p.type) {
        ...
        case 'llm.call.errored':   return p.call_id
        default:                    return null
      }
    },
    summarize: (start, end) => {
  ...
  },
  {
    ...
    correlationId: (p) => {
      switch (p.type) {
        ...
        case 'worker.decision.errored': return p.decision_id
        default:                         return null
      }
    },
    summarize: (start, end) => {
  ...
  },
  {
    ...
    correlationId: (p) => {
      switch (p.type) {
        ...
        case 'tool.call.errored':   return p.tool_call_id
        default:                     return null
      }
    },
    summarize: (start, end) => {
  ...
  },
  {
    ...
    correlationId: (p) => {
      switch (p.type) {
        ...
        case 'sub_agent.errored': return p.session_id
        default:                   return null
      }
    },
    summarize: (start, end) => {

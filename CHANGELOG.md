...
- A tool that answers with an image, audio, or a file keeps it in the blob store, and the model reads it as part of the result.
...
[Unreleased]: https://github.com/substructureai/substructure/compare/v0.5.0...HEAD

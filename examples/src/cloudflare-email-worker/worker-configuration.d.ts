/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c34334a475642cb779daa04d4d0303f6)
// Runtime types generated with workerd@1.20260508.1 2026-03-24 nodejs_compat
declare namespace Cloudflare {
    interface GlobalProps {
        mainModule: typeof import("./src/index");
        durableNamespaces: "AgentState" | "Database";
    }
    interface Env {
        EMAIL: SendEmail;
        AGENT_STATE: DurableObjectNamespace<import("./src/index").AgentState>;
        DATABASE: DurableObjectNamespace<import("./src/index").Database>;
    }
}

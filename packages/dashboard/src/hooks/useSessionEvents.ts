...
async function streamEvents(sessionId: string, signal: AbortSignal, dispatch: (action: Action) => void) {
    try {
...
async function fetchFallback(sessionId: string, dispatch: (action: Action) => void) {
    try {
